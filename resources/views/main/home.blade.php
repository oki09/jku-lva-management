    ...
    <div class="row text-center">
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card">
                ...
                <img class="card-img-bottom" src="{{asset('images/timetable_week.png')}}" alt="">
                <img class="card-img-bottom" src="{{asset('images/timetable_month.png')}}" alt="">
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card">
                ...
                <img class="card-img-bottom" src="{{asset('images/course_list.png')}}" alt="">
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card">
                ...
                <img class="card-img-bottom" src="{{asset('images/responsive.png')}}" alt="">
            </div>
        </div>
    </div>
@endsection
